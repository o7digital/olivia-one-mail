...
export interface MailProvider {
  ...
  sendMessage(input: { to: string; cc?: string; bcc?: string; subject: string; body: string; html?: string }): Promise<{ id: string; status: string }>
  reply(id: string, input: { body: string; html?: string }): Promise<{ id: string; status: string }>
  replyAll(id: string, input: { body: string; html?: string }): Promise<{ id: string; status: string }>
  forward(id: string, input: { to: string; cc?: string; bcc?: string; body: string; html?: string }): Promise<{ id: string; status: string }>
